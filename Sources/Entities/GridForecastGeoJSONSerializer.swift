...
public struct GridForecastGeoJSONSerializer: Codable {
    ...
    public init(referenceTime: Date, mediaType: String? = nil, type: String? = nil, version: String, timestamps: [Date], features: [GeoJSONFeature], filename: String? = nil, bbox: [Double]) {
