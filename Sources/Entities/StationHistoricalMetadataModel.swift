...
public struct StationHistoricalMetadataModel: Codable {
    ...
    public init(title: String, parameters: [ParameterMetadataModel], frequency: String, type: String, mode: String, responseFormats: [String], startTime: Date, endTime: Date, stations: [StationMetadata], idType: IDType) {
        self.title = title
