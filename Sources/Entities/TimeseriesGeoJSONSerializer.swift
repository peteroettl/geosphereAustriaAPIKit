...
public struct TimeseriesGeoJSONSerializer: Codable {
    ...
    public init(mediaType: String? = nil, type: String? = nil, version: String, timestamps: [Date], features: [GeoJSONFeature], filename: String? = nil) {
